...
import com.peigongdh.rpc.core.exception.RequestTimeoutException;
import com.peigongdh.rpc.core.protocol.Request;
import com.peigongdh.rpc.core.protocol.Response;
import com.peigongdh.rpc.core.rpcproxy.CglibRpcProxy;
import com.peigongdh.rpc.core.rpcproxy.RpcProxy;
...
import static com.peigongdh.rpc.core.utils.Constant.ZK_DATA_PATH;
...
public class ClientImpl implements Client {
    ...
    public Response sendMessage(Class<?> clazz, Method method, Object[] args) {
        ...
        try {
            ...
            } catch (RequestTimeoutException e1) {
                e1.printStackTrace();
            }
        } finally {
            try {
